...
LOGS = logging.getLogger("اعداد كولدن")
...
async def saves():
    try:
        ...
        print(str(e))
    try:
        await jmub(UnblockRequest("@TP_P7"))
        await jmub(UnblockRequest("G_O_L_D_EN"))
        await jmub(
        ...
        channel_usernames = ["G_O_L_D_EN", "TP_P7"]
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await jmub.send_message(
                "@G_OLDN1_BOT",
                "تم بنجاح تشغيل سورس كولدن عزيزي المستخدم هذا البوت سيتم تشغيله قريبا بعد اكماله",
            )
            await asyncio.sleep(1)
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_file(
                    BOTLOG_CHATID,
                    "https://telegra.ph/file/0fcebcc475c9ef6d87d2c.jpg",
                    caption="**شكرا لتنصيبك سورس كولدن**\n • هنا بعض الملاحظات التي يجب ان تعرفها عن استخدامك لسورس كولدن.",
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_message(
                    BOTLOG_CHATID,
                    "**لقد تم بنجاح تنصيب سورس كولدن **\n➖➖➖➖➖➖➖➖➖➖\n**السورس**: @G_O_L_D_EN\n**المطور**:@TP_P7 \n➖➖➖➖➖➖➖➖➖➖\n**مجموعة الدعم**: @GO_l2N\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        (Button.url("كروب المساعدة", "https://t.me/GO_l2N"),)
                    ],
                )
        except Exception as e:
            LOGS.error(e)
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كروب بوت كولدن", jmub, Config.TG_BOT_USERNAME, descript, photobt
        )
